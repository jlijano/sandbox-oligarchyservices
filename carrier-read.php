...
$html = str_replace(
    ...
    '<main class="carrier-workspace"><div class="dashboard-alert is-success" role="status">Test page: opening an unread Carrier email marks it read before the list loads.</div>',
    $html
);
