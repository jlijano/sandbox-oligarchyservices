...
<label class="wide-field">Recommended Services<textarea name="recommended_services" rows="3" placeholder="Relevant Oligarchy Services offers for this lead"><?= e((string) ($blank['recommended_services'] ?? '')) ?></textarea></label>
