...
<html lang="en">
  ...
  <body>
    <main class="login-page"><section class="login-hero" aria-labelledby="update-heading"><a class="login-brand-logo" href="/dashboard.php" aria-label="Back to dashboard">OLIGARCHY</a><form class="login-panel" method="post"><div class="login-panel-heading"><p class="eyebrow">Portal update</p><h1 id="update-heading">Update database tables</h1><p>Run safe, non-destructive table updates for the current CMS code. Existing users, pages, settings, and activity are kept.</p></div>
